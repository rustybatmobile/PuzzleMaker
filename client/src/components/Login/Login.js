    ...
    const handleSubmit = async (e) => {
        ...
        if(username.length > 2 && password.length > 5) {
            ...
            if(username.length <= 2) {
                setUsernameError("Username should be more than 2 characters long");
            } else {
                setUsernameError("");
            }
    ...
    return  (
        <div className = {styles.login_container}>
            <form onSubmit={handleSubmit} className = {styles.login_form} >
                ...
                <p className = {styles.signup_text}>Don't have an account yet? Sign up <Link to = "/signup">here.</Link></p>
